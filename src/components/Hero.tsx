...
const Hero = ({ isPacmanActive, isSnakeActive, setIsPacmanActive, setIsSnakeActive }: HeroProps) => {
    ...
    <section className="min-h-screen flex items-center justify-center py-16 px-4">
      <div className="max-w-4xl">
        <motion.p
          ...
          className="text-[rgb(var(--primary))] font-mono mb-5"
        >
          <TypeWriter text="Hi, my name is" delay={150} />
        </motion.p>
        ...
        >
          <TypeWriter text="Harsh Dwivedi." delay={100} />
        </motion.h1>
        ...
        >
          <a
            href="/assets/resume/Harsh_Resume.pdf"
            target="_blank"
